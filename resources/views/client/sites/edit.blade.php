...
<div class="mb-6">
    <div class="flex justify-between items-start">
        <div>
            <nav class="mb-4">
                <a href="{{ route('client.sites.show', $site) }}" class="inline-flex items-center px-4 py-2 bg-gray-100 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-200 transition-colors">
...
<div class="bg-white rounded-lg shadow">
    ...
    <div class="p-6">
        <form action="{{ route('client.sites.update', $site) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="status" 
                            ...
                            class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                            required>
                        @foreach(\App\Models\Site::getStatuses() as $value => $label)
...
<div class="mt-6 bg-white rounded-lg shadow">
    ...
    <div class="p-6">
        ...
        <form action="{{ route('client.sites.destroy', $site) }}" method="POST" onsubmit="return confirm('Bạn có chắc chắn muốn xóa công trường này?')">
            @csrf
            @method('DELETE')
            <button type="submit" 
