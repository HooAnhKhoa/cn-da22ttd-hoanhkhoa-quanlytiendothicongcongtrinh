...
<div class="mb-6">
    <div class="flex justify-between items-start">
        <div>
            <nav class="mb-4">
                <a href="{{ route('client.progress_updates.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-100 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-200 transition-colors">
            ...
            <p class="text-xl text-gray-600 mt-2">
                Công việc: <a href="{{ route('client.tasks.show', $progressUpdate->task_id) }}" class="text-blue-600 hover:text-blue-800">
                    {{ $progressUpdate->task->task_name ?? 'N/A' }}
                </a>
            </p>
        </div>
        <div class="flex gap-2">
            <a href="{{ route('client.progress_updates.edit', $progressUpdate->id) }}"
        ...
        <div class="p-6">
            <div class="space-y-4">
                ...
                <div class="flex justify-between">
                    ...
                    <span class="font-medium text-gray-800">
                        <a href="{{ route('client.tasks.show', $progressUpdate->task_id) }}" class="text-blue-600 hover:text-blue-800">
                            {{ $progressUpdate->task->task_name ?? 'N/A' }}
                        </a>
                    </span>
                </div>
                <div class="flex justify-between">
                    ...
                    <span class="font-medium text-gray-800">
                        ...
                        <a href="{{ route('client.projects.show', $progressUpdate->task->site->project) }}" class="text-blue-600 hover:text-blue-800">
            ...
            <div class="space-y-6">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <div class="font-medium text-gray-800">
                                <a href="{{ route('client.tasks.show', $progressUpdate->task) }}" class="hover:text-blue-600">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <div class="font-medium text-gray-800">
                                <a href="{{ route('client.sites.show', $progressUpdate->task->site) }}" class="hover:text-blue-600">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <div class="font-medium text-gray-800">
                                <a href="{{ route('client.projects.show', $progressUpdate->task->site->project) }}" class="hover:text-blue-600">
                                    {{ $progressUpdate->task->site->project->project_name }}
                                </a>
                            </div>
                ...
                @foreach($files as $file)
                    ...
                    <div class="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                        ...
                        <div class="flex justify-end gap-2">
                            ...
                            @endif
                            <a href="{{ route('client.progress_updates.download', ['id' => $progressUpdate->id, 'filename' => $file]) }}"
...
<div class="flex justify-between items-center mt-8 pt-6 border-t border-gray-200">
    ...
    <div class="flex gap-2">
        <form action="{{ route('client.progress_updates.destroy', $progressUpdate->id) }}" method="POST" class="inline">
            @csrf
            @method('DELETE')
