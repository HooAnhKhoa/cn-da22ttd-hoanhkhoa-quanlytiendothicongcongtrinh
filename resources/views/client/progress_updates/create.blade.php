...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-3xl mx-auto">
        <div class="mb-6">
            <nav class="mb-4">
                @if(request('task_id'))
                    <a href="{{ route('client.tasks.show', request('task_id')) }}" class="inline-flex items-center px-4 py-2 bg-gray-100 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-200 transition-colors">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <form action="{{ route('client.progress_updates.store') }}" method="POST" enctype="multipart/form-data" id="progressForm">
                @csrf
                ...
                <div class="flex justify-end gap-3">
                    <a href="{{ request('task_id') ? route('client.tasks.show', request('task_id')) : route('client.tasks.index') }}"
