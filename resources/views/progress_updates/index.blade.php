...
<div class="container mx-auto px-4 py-8">
    <div class="mb-6">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('progress_updates.create') }}" 
    ...
    <div class="bg-white rounded-lg shadow p-6 mb-6">
        <form method="GET" action="{{ route('progress_updates.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm font-medium text-gray-900">
                                    <a href="{{ route('tasks.show', $update->task_id) }}" 
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    <a href="{{ route('progress_updates.show', $update) }}" 
                                       class="text-blue-600 hover:text-blue-900" title="Xem chi tiết">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('progress_updates.edit', $update) }}" 
                                       class="text-yellow-600 hover:text-yellow-900" title="Chỉnh sửa">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="{{ route('progress_updates.destroy', $update) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" 
