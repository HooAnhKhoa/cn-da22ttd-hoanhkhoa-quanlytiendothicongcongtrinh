...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="p-6">
            @if($recentProjects->count() > 0)
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                        ...
                        <a href="{{ route('admin.projects.show', $project) }}" class="ml-4 p-2 text-blue-600 hover:text-blue-800 hover:bg-blue-50 rounded-lg transition-colors">
            ...
            @else
                <div class="text-center py-8">
                    ...
                    <a href="{{ route('admin.projects.create') }}" class="inline-block mt-2 text-blue-600 hover:text-blue-800 text-sm font-medium">
                        Tạo dự án đầu tiên
                    </a>
                </div>
            @endif
    ...
    <div class="bg-white rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            ...
            <a href="{{ route('admin.tasks.index') }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                Xem tất cả
            </a>
        </div>
        <div class="p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('admin.tasks.show', $task) }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                                Xem chi tiết
                            </a>
                        </div>
            ...
            @else
                <div class="text-center py-8">
                    ...
                    <a href="{{ route('admin.tasks.create') }}" class="inline-block mt-2 text-blue-600 hover:text-blue-800 text-sm font-medium">
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div class="p-6">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <a href="{{ route('admin.material_usage.create') }}" 
    ...
    <div class="bg-white rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            ...
            <a href="{{ route('admin.materials.index') }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                Xem tất cả
            </a>
        </div>
        <div class="p-6">
