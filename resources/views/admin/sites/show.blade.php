...
<div class="mb-6">
    <div class="flex justify-between items-start">
        <div>
            <nav class="mb-4">
                <a href="{{ route('admin.sites.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-100 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-200 transition-colors">
        ...
        <div class="flex gap-2">
            <a href="{{ route('admin.sites.edit', $site) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-white hover:bg-blue-700 transition-colors">
        ...
        <div class="p-6">
            <div class="space-y-4">
                ...
                <div class="flex justify-between">
                    ...
                    @if($site->project)
                        <a href="{{ route('admin.projects.show', $site->project) }}" class="font-medium text-gray-800 hover:text-blue-600">
...
<div class="bg-white rounded-lg shadow mb-8">
    <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
        ...
        <a href="{{ route('admin.tasks.create', ['site_id' => $site->id]) }}" 
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm font-medium text-gray-900">
                                            <a href="{{ route('admin.tasks.show', $task) }}" class="hover:text-blue-600">
                                                {{ $task->task_name }}
                                            </a>
                                        </div>
                                        @if($task->description)
