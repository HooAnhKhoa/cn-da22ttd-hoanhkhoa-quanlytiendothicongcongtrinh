...
<div class="mb-6">
    <div class="flex justify-between items-start">
        ...
        <div class="flex gap-2">
            <a href="{{ route('admin.tasks.edit', $task) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-white hover:bg-blue-700 transition-colors">
                <i class="fas fa-edit mr-2"></i>Chỉnh sửa
            </a>
            <!-- Nút thêm báo cáo tiến độ -->
            <a href="{{ route('admin.progress_updates.create', ['task_id' => $task->id]) }}" class="inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-white hover:bg-green-700 transition-colors">
        ...
        <div class="p-6">
            <div class="space-y-4">
                ...
                <div class="flex justify-between">
                    ...
                    @if($task->parent)
                        <a href="{{ route('admin.tasks.show', $task->parent) }}" class="font-medium text-gray-800">{{ $task->parent->task_name }}</a>
                    @else
                ...
                <div class="flex justify-between">
                    ...
                    <a href="{{ route('admin.sites.show', $task->site)}}">
...
<div class="bg-white rounded-lg shadow mb-8">
    <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
        ...
        <a href="{{ route('admin.progress_updates.create', ['task_id' => $task->id]) }}" 
                            ...
                            <div class="flex justify-between items-start mb-4">
                                ...
                                <div class="text-right">
                                    ...
                                    <div class="flex gap-2 mt-2">
                                        ...
                                        <a href="{{ route('admin.progress_updates.edit', $report) }}" 
                                           class="text-yellow-600 hover:text-yellow-800 text-sm">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="{{ route('admin.progress_updates.destroy', $report) }}" 
...
<div class="bg-white rounded-lg shadow mb-8">
    <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
        ...
        <a href="{{ route('admin.material_usage.create', ['task_id' => $task->id]) }}" 
           class="inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-white hover:bg-green-700 transition-colors">
