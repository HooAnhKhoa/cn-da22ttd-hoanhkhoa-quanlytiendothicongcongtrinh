...
<div class="mb-6">
    <div class="flex justify-between items-start">
        <div>
            <nav class="mb-4">
                <a href="{{ route('sites.show', $site) }}" class="inline-flex items-center px-4 py-2 bg-gray-100 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-200 transition-colors">
...
<div class="mt-6 bg-white rounded-lg shadow">
    ...
    <div class="p-6">
        ...
        <form action="{{ route('sites.destroy', $site) }}" method="POST" onsubmit="return confirm('Bạn có chắc chắn muốn xóa công trường này?')">
            @csrf
            @method('DELETE')
            <button type="submit" 
