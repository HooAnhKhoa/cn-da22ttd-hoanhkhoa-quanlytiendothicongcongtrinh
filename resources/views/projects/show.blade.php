...
<div class="bg-white rounded-lg shadow mb-8">
    <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
        ...
        <a href="{{ route('sites.create', ['project_id' => $project->id]) }}" 
...
<div class="bg-white rounded-lg shadow mb-8">
    <div class="border-b border-gray-200">
        <nav class="flex -mb-px">
            <button class="tab-button active py-4 px-6 text-sm font-medium border-b-2 border-blue-500 text-blue-600" data-tab="milestones">
                        ...
                        <div class="flex justify-between items-start">
                            ...
                            <div class="text-right ml-4">
                                ...
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $milestoneStatusColors[$milestone->status] ?? 'bg-gray-100 text-gray-800' }}">
                                    {{ \App\Models\Milestone::getStatuses()[$milestone->status] ?? $milestone->status }}
                                </span>
                            </div>
                        </div>
                    </div>
