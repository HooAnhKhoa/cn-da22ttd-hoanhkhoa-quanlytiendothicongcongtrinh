...
<div class="mb-6">
    <div class="flex justify-between items-start">
        <div>
            <nav class="mb-4">
                <a href="{{ route('projects.show', $project) }}" class="inline-flex items-center px-4 py-2 bg-gray-100 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-200 transition-colors">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <select name="contractor_id" 
                            ...
                            @foreach($users as $user)
                                <option value="{{ $user->id }}" {{ old('contractor_id', $project->contractor_id) == $user->id ? 'selected' : '' }}>
                                    {{ $user->username }} ({{ $user->email }})
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select name="engineer_id" 
                            ...
                            @foreach($users as $user)
                                <option value="{{ $user->id }}" {{ old('engineer_id', $project->engineer_id) == $user->id ? 'selected' : '' }}>
                                    {{ $user->username }} ({{ $user->email }})
                                </option>
                            @endforeach
                        </select>
